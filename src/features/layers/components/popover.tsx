...
import { TextWell } from "@/components/elements";
import { FORM_ERROR, Form } from "@/components/Form";
...
import { layerConfigAtom } from "@/stores/jotai";
...
import type { Moment } from "@/utils/persistence/moment";
import { get, getMapboxLayerURL, getTileJSON } from "@/utils/utils";
    ...
    >
      ...
      <div className="flex-auto">
        <div className="flex gap-x-2 items-center">
          ...
          {}
          {tilejson && typeof tilejson === "object" && tilejson.bounds ? (
            <button
              type="button"
              title="Zoom to layer"
              className={"opacity-30 hover:opacity-100 select-none"}
...
export function LayersPopover() {
  ...
  return (
    <div>
      ...
      <div
        className="app-scrollbar overflow-y-auto"
        style={{
          maxHeight: 300,
        }}
      >
