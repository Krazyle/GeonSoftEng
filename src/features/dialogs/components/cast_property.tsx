...
import { styledSelect } from "@/components/elements";
import SimpleDialogActions from "@/features/dialogs/components/simple_dialog_actions";
import type { ModalStateCastProperty } from "@/stores/jotai";
import { castExplicit, ExplicitCast } from "@/utils/cast";
import { usePersistence } from "@/utils/persistence/context";
import { useFeatureMap } from "@/utils/persistence/shared";
...
const CAST_TARGET_DOCS: Record<ExplicitCast, React.ReactNode> = {
  ...
  [ExplicitCast.HTML]: `Casting to rich text will reinterpret the given values to be compatible with this application’s
      rich text editor.`,
