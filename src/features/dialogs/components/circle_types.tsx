...
export function CircleTypesDialog() {
  return (
    <>
      ...
      <div>
        <p>
          This application supports three different kinds of circles: Mercator,
        ...
        <p>
          ...
          because they’re drawn according to the web mercator projection. These
          circles will also look like circles on standard Mapbox,
