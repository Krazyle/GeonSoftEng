...
import { asHTML, castExplicit, ExplicitCast } from "@/utils/cast";
...
function BooleanEditor({
  ...
  return (
    <label
      {...coordPropsAttr({ x, y })}
      className="select-none block py-2 px-2 items-center gap-x-2 text-xs dark:text-white"
    >
      <input
      ...
      <P.Portal>
        ...
        >
          <div
            ...
            app-scrollbar w-full text-xs rounded-md"
            style={{
              maxHeight: 100,
            }}
          >
