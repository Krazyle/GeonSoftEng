...
import { dataAtom, showAllAtom } from "@/stores/jotai";
import { onArrow } from "@/utils/arrow_navigation";
import { castExplicit, type ExplicitCast } from "@/utils/cast";
import { deletePropertyKey } from "@/utils/map_operations/delete_property_key";
import { updatePropertyKey } from "@/utils/map_operations/update_property_key";
import { updatePropertyValue } from "@/utils/map_operations/update_property_value";
import { extractPropertyKeys } from "@/utils/multi_properties";
...
function FeatureEditorPropertiesRaw({
  ...
  return (
    <div
      className="overflow-y-auto app-scrollbar"
      data-focus-scope
      onKeyDown={onArrow}
    >
