...
import { ColorPopoverField } from "@/components/color_popover";
import {
  Button,
  Hint,
  inputClass,
...
} from "@/components/panel_details";
import { useAutoSubmit } from "@/hooks/use_auto_submit";
import { captureException } from "@/lib/integrations/errors";
import { dataAtom, panelSymbolizationExportOpen } from "@/stores/jotai";
...
} from "@/utils/colorbrewer";
import { purple900 } from "@/utils/constants";
import { type EOption, exportStyle } from "@/utils/export_style";
import { usePersistence } from "@/utils/persistence/context";
import { lerp, writeToClipboard } from "@/utils/utils";
                    ...
                    <P.Root>
                      ...
                      <PopoverContent2 side="left">
                        ...
                        <div
                          ...
                          className="space-y-2 p-1 overflow-y-auto app-scrollbar"
                        >
