...
import AddColumn from "@/features/panels/components/feature_table/add_column";
import { FeatureTableStats } from "@/features/panels/components/feature_table/feature_table_stats";
import { Header } from "@/features/panels/components/feature_table/header";
import { PropertyColumn } from "@/features/panels/components/feature_table/property_column";
import RowActions from "@/features/panels/components/feature_table/row_actions";
import TableEmptyState from "@/features/panels/components/feature_table/table_empty_state";
...
import { onArrow } from "@/utils/arrow_navigation";
import { geometryTypes } from "@/utils/constants";
import { getFn, useColumns } from "@/utils/search_utils";
...
function FeatureTableInner({ data }: { data: Data }) {
  ...
  return (
    <>
      ...
      <div
        ref={parentRef}
        className="overflow-auto flex-auto app-scrollbar"
        data-focus-scope
        onKeyUp={onArrow}
      >
        <div
