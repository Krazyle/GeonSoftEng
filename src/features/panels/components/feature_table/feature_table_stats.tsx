...
import { formatCount, pluralize } from "@/utils/utils";
...
export function FeatureTableStats({
  ...
  return (
    <div
      className="mt-2 rounded-sm p-3 dark:text-white bg-gray-100 dark:bg-gray-900 overflow-y-auto app-scrollbar"
      style={{
        maxHeight: 420,
      }}
    >
...
function StatValuePopover({ stats }: { stats: RetStat }) {
  ...
  return (
    <div ref={parentRef} className="text-xs overflow-y-auto h-48 app-scrollbar">
      <div
