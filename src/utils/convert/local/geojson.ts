...
import { APP_FOLDER_PROP, APP_ID_PROP } from "@/utils/constants";
import { addBbox, e6feature } from "@/utils/geometry";
...
function wrappedFeatureToExportable(
  ...
  if (options?.includeId) {
    ...
    feature.properties[APP_ID_PROP] = id;
    if (folderId) {
      feature.properties[APP_FOLDER_PROP] = folderId;
    }
  }
